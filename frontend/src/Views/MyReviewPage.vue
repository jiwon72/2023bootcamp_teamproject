<template>
  <div class="rev-container">
    ...
    <div class="rev-textarea-footer">
      <textarea
        type="text"
        class="rev-textarea-field"
        v-model="review"
      ></textarea>
    </div>
    <div class="rev-footer-buttons">
      <div v-if="IsWriter" class="rev-delete" @click="deleteReview">리뷰삭제</div>
      <div v-if="IsWriter" class="rev-edit" @click="editReview">리뷰수정</div>
    ...
    async getReview(reviewId) {
      try {
        ...
        if (response.ok) {
          ...
          console.log("test", data.reviews[0]);
