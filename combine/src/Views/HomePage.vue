    ...
    <div class="home-top-bar">
      ...
      <div class="home-search-box-centered">
        <div class="home-search-box-container">
          <input class="home-search-box" type="text" placeholder="영화 검색" />
          <button @click="goToMenuPage" class="home-search-button" type="submit">
  ...
  <div class="home-content-container">
    <div class="home-left_list">
      ...
      <div class="home-genre-menu" v-show="showGenre" @mouseleave="hideMenus">
        ...
        <div @click="goToSelectGrow" class="home-genre-item">성장</div>
        <div @click="goToSelectAction" class="home-genre-item">액션</div>
        <div @click="goToSelectEtc" class="home-genre-item">기타</div>
      </div>
      ...
      <div class="home-platform-menu" v-show="showPlatform" @mouseleave="hideMenus">
        <div @click="goToSelectNetflex" class="home-platform-item">넷플릭스</div>
        ...
        <div @click="goToSelectTving" class="home-platform-item">티빙</div>
        <div @click="goToSelectWatcha" class="home-platform-item">왓차</div>
      </div>
    </div>
    <div class="home-right-content">
      <div class="home-top-10-and-sort">
        <div class="home-top-10">TOP10</div>
        <div class="home-dropdown" @click="toggleDropdown">
          정렬순 ▼
          <div class="home-dropdown-menu" v-show="showDropdown" @mouseleave="hideDropdown">
            <div class="home-dropdown-item">현재 상영중인 영화</div>
            <div class="home-dropdown-item">OTT 인기영화</div>
          </div>
        </div>
      </div>
      <div class="home-movies">
        <div class="home-poster">
          <div @click="goToMovieinformationPage" class="home-card" style="width: 18rem">
            <img
              src="/images/lalalandposter.jpeg"
              class="home-movieposter"
              alt="movieposter"
            />
            <div class="home-card-body">
              <h5 class="home-card-title">영화명</h5>
            </div>
          </div>
        </div>
        <div class="home-poster">
